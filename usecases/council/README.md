...
- [Kiro Local Council](kiro-local-council.md) — evidence `field-tested`, conformance `mapped`; same-runtime, same-model-family role-diverse design review covering selected `council:L0` mechanisms, without independent CandidateArtifacts or anonymized peer review.
